...
- **Phase 15** (v3.8.0): 后台管理全面重构 — AdminLayout 侧边栏 / 用户管理 / 作品管理 / 评论管理 / 竞赛管理 / 班级管理 / 数据统计
- **Phase 16** (v3.8.1): Scratch 编辑器可靠性修复 — loading 状态 / 超时兜底 / postMessage 安全 / Nginx 缓存
- **Phase 17** (v3.8.2): CI 修复 + Scratch 编辑器加载修复 + 代码质量全面提升
